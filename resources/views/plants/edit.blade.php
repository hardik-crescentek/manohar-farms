    ...
    <div class="col-lg-12 col-md-12">
        <div class="card custom-card">
            <div class="card-body">
                ...
                <form class="parsley-validate" method="post" action="{{ route('plants.update', $plant->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row row-sm">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" required="" type="text" value="{{ old('name', $plant->name) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="location" required="" type="text" value="{{ old('location', $plant->location) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="">Area</label>
                                <input class="form-control" name="area" required="" type="text" value="{{ old('area', $plant->area) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="">Quantity <span class="text-danger">*</span></label>
                                <input class="form-control" name="quantity" required="" type="number" value="{{ old('quantity', $plant->quantity) }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="price" type="text" onkeypress="return onlyDecimal(event)" value="{{ old('price', $plant->price) }}" required="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="">Nursery</label>
                                <input class="form-control" name="nursery" type="text" value="{{ old('nursery', $plant->nursery) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
