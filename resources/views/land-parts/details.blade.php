        ...
        <div class="card custom-card">
            <div class="card-body">
                <a class="card-order" href="javascript:;">
                    ...
                    <h2 class="text-right"><i class="icon-size mdi mdi-water float-left text-primary"></i><span class="font-weight-bold">{{ $totalWaterUsage }}</span></h2>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <a class="card-order" href="javascript:;">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-water icon-size float-left text-primary"></i><span class="font-weight-bold">{{ $monthlyWaterUsage }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <a class="card-order " href="javascript:;">
                    ...
                    <h2 class="text-right card-item-icon card-icon">
                        <i class="mdi mdi-water icon-size float-left text-primary"></i><span class="font-weight-bold">{{ $totalLitrUsed }}</span>
                    </h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </a>
            </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <a class="card-order" href="javascript:;">
                    ...
                    <h2 class="text-right"><i class="mdi mdi-water icon-size float-left text-primary"></i><span class="font-weight-bold">{{ $monthlyLitrUsed }}</span></h2>
                    <p class="mb-0 mt-4 text-muted"> - <span class="float-right"> </span></p>
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="label-value mt-2">
                            <strong>Land Part:</strong>
                            <img src="{{ asset('uploads/land_parts/'.$partDetail->image) }}" alt="" width="80">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mt-2">
                        <div class="input-group">
                            <input type="text" name="waterrange" id="waterrange" class="form-control reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
                    ...
                    <div class="col-md-4 mt-2 d-flex justify-content-end">
                        <a href="javascript:;" class="btn btn-primary" data-target="#addWaterEntry" data-toggle="modal">Add Water entry</a>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
        ...
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mt-2">
                        <div class="input-group">
                            <input type="text" name="fertilizerrange" id="fertilizerrange" class="form-control reportrange" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mt-2 d-flex justify-content-end">
                        <a href="javascript:;" class="btn btn-primary" data-target="#addFertilizerEntry" data-toggle="modal">Add Fertilizer</a>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-12">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Add Water Entry</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <form class="parsley-validate" method="post" action="{{ route('land-parts.save-water-entries') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text" name="date" id="water-date" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="time" type="text" value="{{ old('time') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="">Hours</label>
                                <input class="form-control" name="hours" type="text" value="{{ old('hours') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="">Person</label>
                                <input class="form-control" name="person" type="text" value="{{ old('person') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="">Volume</label>
                                <input class="form-control" name="volume" type="text" value="{{ old('volume') }}">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal" id="addFertilizerEntry">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Add Fertilizer entry</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
            <form class="parsley-validate" method="post" action="{{ route('land-parts.save-fertilizer-entries') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row row-sm">
                        <input type="hidden" name="land_id" value="{{ $partDetail->land_id }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" placeholder="YYYY/MM/DD" type="text" name="date" id="fertilizer-date" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="fertilizer_name" type="text" value="{{ old('fertilizer_name') }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="remarks" type="text" value="{{ old('remarks') }}">
                            </div>
                        </div>
                    </div>
                </div>
